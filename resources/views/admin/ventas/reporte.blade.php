...
<head>
    ...
    <title>{{ $empresa->nombre_empresa}} | Reporte Ventas</title>
    <style>
        body {
    ...
    <div class="content">
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td width="100px" style="background-color: #cccccc; text-align: center"><b>Fecha de Venta</b></td>
                <td width="100px" style="background-color: #cccccc; text-align: center"><b>Precio Total</b></td>
                <td width="70px" style="background-color: #cccccc; text-align: center"><b>Cliente</b></td>
                <td width="40px" style="background-color: #cccccc; text-align: center"><b>NIT/Código</b></td>
                ...
                <tbody style="text-align: center">
                    ...
                    <tr>
                        ...
                        <td>{{ $venta->cliente->nit_codigo ?? '0' }}</td>
