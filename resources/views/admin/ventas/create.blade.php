...
@section('content_header')
    <h1><b>Ventas/Registrar Nueva Venta</b></h1>
    <hr>
@stop
            ...
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                @foreach ($tmp_ventas as $tmp_venta)
                                    <tr>
                                        <td style="text-align: center;vertical-align: middle">{{ $contador++ }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $tmp_venta->producto->codigo }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $tmp_venta->cantidad }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $tmp_venta->producto->nombre }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $tmp_venta->producto->precio_venta }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $total_producto = $tmp_venta->cantidad * $tmp_venta->producto->precio_venta }}</td>
                                        <td style="text-align: center;vertical-align: middle">
                                            <button type="button" class="btn btn-danger align-center delete-btn" data-id="{{ $tmp_venta->id }}"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    <?php 
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div style="height: 32px"></div>
                                    ...
                                    <a href="{{ route('admin.clientes.create') }}" class="btn btn-success"><i class="fas fa-plus"></i></a>
                                    <!-- Modal -->
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre_cliente" value="S/N" disabled>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nit_cliente" value="0" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="telefono_cliente" value="0" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email_cliente" value="S/E" disabled>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-success btn-block"><i class="fas fa-save"></i> Registrar Venta</button>
                            </div>
                        </div>
                    </div>
                    </form>
...
@section('js')
    <script>
        ...
        $('.delete-btn').on('click', function () {
            ...
            if(id) {
                $.ajax({
                    url: "{{ route('admin.ventas.tmp_ventas')}}/"+id,
                    type: 'POST',
                    data: {
                        _token:'{{csrf_token()}}',
                        _method: 'DELETE',
