...
<head>
    ...
    <title>{{ $empresa->nombre_empresa}} | Reporte Usuarios</title>
    <style>
        body {
    ...
    <div class="content">
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td width="150px" style="background-color: #cccccc; text-align: center"><b>Nombre del Usuario</b></td>
                <td width="150px" style="background-color: #cccccc; text-align: center"><b>Correo del Usuario</b></td>
