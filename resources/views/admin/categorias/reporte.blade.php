...
<head>
    ...
    <title>{{ $empresa->nombre_empresa}} | Reporte Categorias</title>
    <style>
        body {
    ...
    <div class="content">
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td width="150px" style="background-color: #cccccc; text-align: center"><b>Nombre de la Categoria</b></td>
                <td width="150px" style="background-color: #cccccc; text-align: center"><b>Desccripción</b></td>
