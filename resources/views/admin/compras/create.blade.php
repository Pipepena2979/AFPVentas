...
@section('content_header')
    <h1><b>Compras/Registrar Nueva Compra</b></h1>
    <hr>
@stop
            ...
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                @foreach ($tmp_compras as $tmp_compra)
                                    <tr>
                                        <td style="text-align: center;vertical-align: middle">{{ $contador++ }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $tmp_compra->producto->codigo }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $tmp_compra->cantidad }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $tmp_compra->producto->nombre }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $tmp_compra->producto->precio_compra }}</td>
                                        <td style="text-align: center;vertical-align: middle">{{ $total_producto = $tmp_compra->cantidad * $tmp_compra->producto->precio_compra }}</td>
                                        <td style="text-align: center;vertical-align: middle">
                                            <button type="button" class="btn btn-danger align-center delete-btn" data-id="{{ $tmp_compra->id }}"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    <?php 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-success btn-block"><i class="fas fa-save"></i> Registrar Compra</button>
                            </div>
                        </div>
                    </div>
                    </form>
